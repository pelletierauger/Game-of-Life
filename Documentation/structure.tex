...
\lstdefinelanguage{JavaScript}{
    ...
    keywordstyle=\lst@ifdisplaystyle\color{darkblue}\lstsansserif\fi,
    ...
    keywordstyle=\lst@ifdisplaystyle\color{p5pink}\lstsansserif\fi
}

\lstset{backgroundcolor=\color{grey},
    numbers=left,
    columns=fullflexible,
    basicstyle=\lstsansserif\lst@ifdisplaystyle\fontsize{10}{12}\fi,
    language=JavaScript,
